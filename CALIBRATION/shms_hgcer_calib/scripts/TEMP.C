...
void TEMP()
{
  ...
  TFile *F = new TFile("../ROOTfile/scratch/shms_replay_483.root");

  //Output Histograms
  TFile *g = new TFile("root_files/shms_calibration.root", "RECREATE");
  ...
  Double_t phgc_pulseTimeRaw[maxAdcHits*nhgc_pmts];
  ...
  TH1F *h_phgc_quad1_e[4];
  TH1F *h_phgc_quad1_pi[4];
  TH1F *h_phgc_quad1_sum[4];

  TH1F *h_phgc_quad2_e[4];
  TH1F *h_phgc_quad2_pi[4];
  TH1F *h_phgc_quad2_sum[4];

  TH1F *h_phgc_quad3_e[4];
  TH1F *h_phgc_quad3_pi[4];
  TH1F *h_phgc_quad3_sum[4];

  TH1F *h_phgc_quad4_e[4];
  TH1F *h_phgc_quad4_pi[4];
  TH1F *h_phgc_quad4_sum[4];
  ...
  h_phgc_adcPulseTimeCorr_T1[0] = new TH1F("phgc_adcPulseTimeCorr1", "Corrected Pulse Time PMT1; PulseTimeRaw - T1 (ns); Counts", bins, adc_min, adc_max);
  h_phgc_adcPulseTimeCorr_T1[1] = new TH1F("phgc_adcPulseTimeCorr2", "Corrected Pulse Time PMT2; PulseTimeRaw - T1 (ns); Counts", bins, adc_min, adc_max);
  h_phgc_adcPulseTimeCorr_T1[2] = new TH1F("phgc_adcPulseTimeCorr3", "Corrected Pulse Time PMT3; PulseTimeRaw - T1 (ns); Counts", bins, adc_min, adc_max);
  h_phgc_adcPulseTimeCorr_T1[3] = new TH1F("phgc_adcPulseTimeCorr4", "Corrected Pulse Time PMT4; PulseTimeRaw - T1 (ns); Counts", bins, adc_min, adc_max);

  h_phgc_adcPulseTimeCorr_T2[0] = new TH1F("phgc_adcPulseTimeCorr1", "Corrected Pulse Time PMT1; PulseTimeRaw - T2 (ns); Counts", bins, adc_min, adc_max);
  h_phgc_adcPulseTimeCorr_T2[1] = new TH1F("phgc_adcPulseTimeCorr2", "Corrected Pulse Time PMT2; PulseTimeRaw - T2 (ns); Counts", bins, adc_min, adc_max);
  h_phgc_adcPulseTimeCorr_T2[2] = new TH1F("phgc_adcPulseTimeCorr3", "Corrected Pulse Time PMT3; PulseTimeRaw - T2 (ns); Counts", bins, adc_min, adc_max);
  h_phgc_adcPulseTimeCorr_T2[3] = new TH1F("phgc_adcPulseTimeCorr4", "Corrected Pulse Time PMT4; PulseTimeRaw - T2 (ns); Counts", bins, adc_min, adc_max);

  h_phgc_adcPulseTimeCorr_T3[0] = new TH1F("phgc_adcPulseTimeCorr1", "Corrected Pulse Time PMT1; PulseTimeRaw - T3 (ns); Counts", bins, adc_min, adc_max);
  h_phgc_adcPulseTimeCorr_T3[1] = new TH1F("phgc_adcPulseTimeCorr2", "Corrected Pulse Time PMT2; PulseTimeRaw - T3 (ns); Counts", bins, adc_min, adc_max);
  h_phgc_adcPulseTimeCorr_T3[2] = new TH1F("phgc_adcPulseTimeCorr3", "Corrected Pulse Time PMT3; PulseTimeRaw - T3 (ns); Counts", bins, adc_min, adc_max);
  h_phgc_adcPulseTimeCorr_T3[3] = new TH1F("phgc_adcPulseTimeCorr4", "Corrected Pulse Time PMT4; PulseTimeRaw - T3 (ns); Counts", bins, adc_min, adc_max);
  ...
  h_phgc_quad1_e[0] = new TH1F ("phgc_quad1_e1", "Electrons in Quadrant 1 PMT1; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad1_e[1] = new TH1F ("phgc_quad1_e2", "Electrons in Quadrant 1 PMT2; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad1_e[2] = new TH1F ("phgc_quad1_e3", "Electrons in Quadrant 1 PMT3; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad1_e[3] = new TH1F ("phgc_quad1_e4", "Electrons in Quadrant 1 PMT4; PulseInt; Counts", bins, 0, 14000);

  h_phgc_quad1_pi[0] = new TH1F ("phgc_quad1_pi1", "Pions in Quadrant 1 PMT1; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad1_pi[1] = new TH1F ("phgc_quad1_pi2", "Pions in Quadrant 1 PMT2; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad1_pi[2] = new TH1F ("phgc_quad1_pi3", "Pions in Quadrant 1 PMT3; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad1_pi[3] = new TH1F ("phgc_quad1_pi4", "Pions in Quadrant 1 PMT4; PulseInt; Counts", bins, 0, 14000);

  h_phgc_quad1_sum[0] = new TH1F ("phgc_quad1_sum1", "Sum in Quadrant 1 PMT1; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad1_sum[1] = new TH1F ("phgc_quad1_sum2", "Sum in Quadrant 1 PMT2; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad1_sum[2] = new TH1F ("phgc_quad1_sum3", "Sum in Quadrant 1 PMT3; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad1_sum[3] = new TH1F ("phgc_quad1_sum4", "Sum in Quadrant 1 PMT4; PulseInt; Counts", bins, 0, 14000);

  h_phgc_quad2_e[0] = new TH1F ("phgc_quad2_e1", "Electrons in Quadrant 2 PMT1; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad2_e[1] = new TH1F ("phgc_quad2_e2", "Electrons in Quadrant 2 PMT2; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad2_e[2] = new TH1F ("phgc_quad2_e3", "Electrons in Quadrant 2 PMT3; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad2_e[3] = new TH1F ("phgc_quad2_e4", "Electrons in Quadrant 2 PMT4; PulseInt; Counts", bins, 0, 14000);

  h_phgc_quad2_pi[0] = new TH1F ("phgc_quad2_pi1", "Pions in Quadrant 2 PMT1; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad2_pi[1] = new TH1F ("phgc_quad2_pi2", "Pions in Quadrant 2 PMT2; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad2_pi[2] = new TH1F ("phgc_quad2_pi3", "Pions in Quadrant 2 PMT3; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad2_pi[3] = new TH1F ("phgc_quad2_pi4", "Pions in Quadrant 2 PMT4; PulseInt; Counts", bins, 0, 14000);

  h_phgc_quad2_sum[0] = new TH1F ("phgc_quad2_sum1", "Sum in Quadrant 2 PMT1; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad2_sum[1] = new TH1F ("phgc_quad2_sum2", "Sum in Quadrant 2 PMT2; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad2_sum[2] = new TH1F ("phgc_quad2_sum3", "Sum in Quadrant 2 PMT3; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad2_sum[3] = new TH1F ("phgc_quad2_sum4", "Sum in Quadrant 2 PMT4; PulseInt; Counts", bins, 0, 14000);

  h_phgc_quad3_e[0] = new TH1F ("phgc_quad3_e1", "Electrons in Quadrant 3 PMT1; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad3_e[1] = new TH1F ("phgc_quad3_e2", "Electrons in Quadrant 3 PMT2; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad3_e[2] = new TH1F ("phgc_quad3_e3", "Electrons in Quadrant 3 PMT3; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad3_e[3] = new TH1F ("phgc_quad3_e4", "Electrons in Quadrant 3 PMT4; PulseInt; Counts", bins, 0, 14000);

  h_phgc_quad3_pi[0] = new TH1F ("phgc_quad3_pi1", "Pions in Quadrant 3 PMT1; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad3_pi[1] = new TH1F ("phgc_quad3_pi2", "Pions in Quadrant 3 PMT2; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad3_pi[2] = new TH1F ("phgc_quad3_pi3", "Pions in Quadrant 3 PMT3; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad3_pi[3] = new TH1F ("phgc_quad3_pi4", "Pions in Quadrant 3 PMT4; PulseInt; Counts", bins, 0, 14000);

  h_phgc_quad3_sum[0] = new TH1F ("phgc_quad3_sum1", "Sum in Quadrant 3 PMT1; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad3_sum[1] = new TH1F ("phgc_quad3_sum2", "Sum in Quadrant 3 PMT2; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad3_sum[2] = new TH1F ("phgc_quad3_sum3", "Sum in Quadrant 3 PMT3; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad3_sum[3] = new TH1F ("phgc_quad3_sum4", "Sum in Quadrant 3 PMT4; PulseInt; Counts", bins, 0, 14000);

  h_phgc_quad4_e[0] = new TH1F ("phgc_quad4_e1", "Electrons in Quadrant 4 PMT1; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad4_e[1] = new TH1F ("phgc_quad4_e2", "Electrons in Quadrant 4 PMT2; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad4_e[2] = new TH1F ("phgc_quad4_e3", "Electrons in Quadrant 4 PMT3; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad4_e[3] = new TH1F ("phgc_quad4_e4", "Electrons in Quadrant 4 PMT4; PulseInt; Counts", bins, 0, 14000);

  h_phgc_quad4_pi[0] = new TH1F ("phgc_quad4_pi1", "Pions in Quadrant 4 PMT1; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad4_pi[1] = new TH1F ("phgc_quad4_pi2", "Pions in Quadrant 4 PMT2; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad4_pi[2] = new TH1F ("phgc_quad4_pi3", "Pions in Quadrant 4 PMT3; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad4_pi[3] = new TH1F ("phgc_quad4_pi4", "Pions in Quadrant 4 PMT4; PulseInt; Counts", bins, 0, 14000);

  h_phgc_quad4_sum[0] = new TH1F ("phgc_quad4_sum1", "Sum in Quadrant 4 PMT1; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad4_sum[1] = new TH1F ("phgc_quad4_sum2", "Sum in Quadrant 4 PMT2; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad4_sum[2] = new TH1F ("phgc_quad4_sum3", "Sum in Quadrant 4 PMT3; PulseInt; Counts", bins, 0, 14000);
  h_phgc_quad4_sum[3] = new TH1F ("phgc_quad4_sum4", "Sum in Quadrant 4 PMT4; PulseInt; Counts", bins, 0, 14000);
  ...
  for (UInt_t ievent = 0; ievent < nentries; ievent++)
	...
	h_p1X_plTime->Fill(p1X_goodPosTdcTimeCorr[igoodhit]);
	  ...
	  for (UInt_t ihgchit = 0; ihgchit < phgc_hits; ihgchit++)
	    {
	      pmt_hit = phgc_pmt[ihgchit] - 1;

	      //Basic Quantities
	      h_phgc_adcPulseInt[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
	      h_phgc_adcPulseAmp[pmt_hit]->Fill(phgc_pulseAmp[ihgchit]);
	      h_phgc_adcPulseTimeRaw[pmt_hit]->Fill(phgc_pulseTimeRaw[ihgchit]);

	      //Timing Information
	      h_phgc_adcPulseTimeCorr_T1[pmt_hit]->Fill(phgc_pulseTimeRaw[ihgchit]*clk2adc - pT1_tdcTime*clk2tdc);
	      h_phgc_adcPulseTimeCorr_T2[pmt_hit]->Fill(phgc_pulseTimeRaw[ihgchit]*clk2adc - pT2_tdcTime*clk2tdc);
	      h_phgc_adcPulseTimeCorr_T3[pmt_hit]->Fill(phgc_pulseTimeRaw[ihgchit]*clk2adc - pT3_tdcTime*clk2tdc);
	      
	      h2_phgc_pulseTime_pT1_pmt->Fill(phgc_pmt[ihgchit], phgc_pulseTimeRaw[ihgchit]*clk2adc - pT1_tdcTime*clk2tdc);
	      h2_phgc_pulseTime_pT2_pmt->Fill(phgc_pmt[ihgchit], phgc_pulseTimeRaw[ihgchit]*clk2adc - pT2_tdcTime*clk2tdc);
	      h2_phgc_pulseTime_pT3_pmt->Fill(phgc_pmt[ihgchit], phgc_pulseTimeRaw[ihgchit]*clk2adc - pT3_tdcTime*clk2tdc);

	      h2_phgc_pulseTime_pT1_diff->Fill(pT1_tdcTime*clk2tdc, phgc_pulseTimeRaw[ihgchit]*clk2adc);
	      h2_phgc_pulseTime_pT2_diff->Fill(pT2_tdcTime*clk2tdc, phgc_pulseTimeRaw[ihgchit]*clk2adc);
	      h2_phgc_pulseTime_pT3_diff->Fill(pT3_tdcTime*clk2tdc, phgc_pulseTimeRaw[ihgchit]*clk2adc);      
	      
	      h2_phgc_adcInt_TimeRaw[pmt_hit]->Fill(phgc_pulseTimeRaw[ihgchit]*clk2adc, phgc_pulseInt[ihgchit]);
	      
	      h2_phgc_adcInt_T1[pmt_hit]->Fill(pT1_tdcTime*clk2tdc, phgc_pulseInt[ihgchit]);
	      h2_phgc_adcInt_T2[pmt_hit]->Fill(pT2_tdcTime*clk2tdc, phgc_pulseInt[ihgchit]);
	      h2_phgc_adcInt_T3[pmt_hit]->Fill(pT3_tdcTime*clk2tdc, phgc_pulseInt[ihgchit]);

	      h2_phgc_pulseInt_pT1[pmt_hit]->Fill(phgc_pulseTimeRaw[ihgchit]*clk2adc - pT1_tdcTime*clk2tdc, phgc_pulseInt[ihgchit]);
	      h2_phgc_pulseInt_pT2[pmt_hit]->Fill(phgc_pulseTimeRaw[ihgchit]*clk2adc - pT2_tdcTime*clk2tdc, phgc_pulseInt[ihgchit]);
	      h2_phgc_pulseInt_pT3[pmt_hit]->Fill(phgc_pulseTimeRaw[ihgchit]*clk2adc - pT3_tdcTime*clk2tdc, phgc_pulseInt[ihgchit]);

	      h2_phgc_TimeWalk_T1[pmt_hit]->Fill(phgc_pulseAmp[ihgchit], phgc_pulseTimeRaw[ihgchit]*clk2adc - pT1_tdcTime*clk2tdc);
	      h2_phgc_TimeWalk_T2[pmt_hit]->Fill(phgc_pulseAmp[ihgchit], phgc_pulseTimeRaw[ihgchit]*clk2adc - pT2_tdcTime*clk2tdc);
	      h2_phgc_TimeWalk_T3[pmt_hit]->Fill(phgc_pulseAmp[ihgchit], phgc_pulseTimeRaw[ihgchit]*clk2adc - pT3_tdcTime*clk2tdc);
	      
	      //Performing cuts on PulseAmp to eliminate large counts with PulseInt = 0
	      if (phgc_pulseAmp[ihgchit] <= 10) h_phgc_pulseAmp_10[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
	      if (phgc_pulseAmp[ihgchit] > 10)  h_phgc_pulseAmp_no10[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
	      if (phgc_pulseAmp[ihgchit] <= 20) h_phgc_pulseAmp_20[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
	      if (phgc_pulseAmp[ihgchit] > 20)  h_phgc_pulseAmp_no20[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
	      if (phgc_pulseAmp[ihgchit] <= 30) h_phgc_pulseAmp_30[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
	      if (phgc_pulseAmp[ihgchit] > 30)  h_phgc_pulseAmp_no30[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
	      if (phgc_pulseAmp[ihgchit] <= 40) h_phgc_pulseAmp_40[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
	      if (phgc_pulseAmp[ihgchit] > 40)  h_phgc_pulseAmp_no40[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
	      if (phgc_pulseAmp[ihgchit] <= 50) h_phgc_pulseAmp_50[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
	      if (phgc_pulseAmp[ihgchit] > 50)  h_phgc_pulseAmp_no50[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
	      if (phgc_pulseAmp[ihgchit] <= 60) h_phgc_pulseAmp_60[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
	      if (phgc_pulseAmp[ihgchit] > 60)  h_phgc_pulseAmp_no60[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
	      if (phgc_pulseAmp[ihgchit] <= 70) h_phgc_pulseAmp_70[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
	      if (phgc_pulseAmp[ihgchit] > 70)  h_phgc_pulseAmp_no70[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);	      
		
	      //Particle ID cuts with a linear cut
	      /*
	      if (pngc_adcInt > shwr_ngc_id->Eval(ppshwr_adcPulseInt + pshwr_adcPulseInt)) h_phgc_ecut_shwr[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
	      if (pngc_adcInt < shwr_ngc_id->Eval(ppshwr_adcPulseInt + pshwr_adcPulseInt)) h_phgc_picut_shwr[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
	      */
	      //Particle ID cuts with a 1/x cut
	      
	      if (pngc_adcInt >= 2000 && pngc_adcInt != 0.0 && (ppshwr_adcPulseInt + pshwr_adcPulseInt) != 0.0)
		{
		  if ((ppshwr_adcPulseInt + pshwr_adcPulseInt) >= shwr_ngc_id->Eval(pngc_adcInt)) h_phgc_ecut_shwr[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
		  if ((ppshwr_adcPulseInt + pshwr_adcPulseInt) < shwr_ngc_id->Eval(pngc_adcInt)) h_phgc_picut_shwr[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
		}

	      if (pngc_adcInt < 2000 && pngc_adcInt != 0.0 && (ppshwr_adcPulseInt + pshwr_adcPulseInt) != 0.0)
		{
		  h_phgc_picut_shwr[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
		}
	      
	      //Tracking Information in HGC
	      h2_ptrk_hgc[pmt_hit]->Fill(trk_x[0] + trk_theta[0] * nhgc_z, trk_y[0] + trk_phi[0] * nhgc_z, phgc_pulseInt[ihgchit]);
	      h2_ptrk_hgc_adcAmp[pmt_hit]->Fill(trk_x[0] + trk_theta[0] * nhgc_z, trk_y[0] + trk_phi[0] * nhgc_z, phgc_pulseAmp[ihgchit]);

	      if (phgc_pulseAmp[ihgchit] > 70) //Condition to remove peak at 0
		{
		  if (trk_y[0] + trk_phi[0] * nhgc_z >= 4.6 && trk_x[0] + trk_theta[0] * nhgc_z >= 9.4)
		    {
		      h_phgc_quad1_sum[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
		      if (pngc_adcInt >= 2000 && pngc_adcInt != 0.0 && (ppshwr_adcPulseInt + pshwr_adcPulseInt) != 0.0)
			{
			  if ((ppshwr_adcPulseInt + pshwr_adcPulseInt) >= shwr_ngc_id->Eval(pngc_adcInt)) h_phgc_quad1_e[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
			  if ((ppshwr_adcPulseInt + pshwr_adcPulseInt) < shwr_ngc_id->Eval(pngc_adcInt)) h_phgc_quad1_pi[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
			}
		      if (pngc_adcInt < 2000 && pngc_adcInt != 0.0 && (ppshwr_adcPulseInt + pshwr_adcPulseInt) != 0.0)
			{
			  h_phgc_quad1_pi[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
			}	
		    }//Quadrant 1

		  if (trk_y[0] + trk_phi[0] * nhgc_z < 4.6 && trk_x[0] + trk_theta[0] * nhgc_z >= 9.4)
		    {
		      h_phgc_quad2_sum[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
		      if (pngc_adcInt >= 2000 && pngc_adcInt != 0.0 && (ppshwr_adcPulseInt + pshwr_adcPulseInt) != 0.0)
			{
			  if ((ppshwr_adcPulseInt + pshwr_adcPulseInt) >= shwr_ngc_id->Eval(pngc_adcInt)) h_phgc_quad2_e[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
			  if ((ppshwr_adcPulseInt + pshwr_adcPulseInt) < shwr_ngc_id->Eval(pngc_adcInt)) h_phgc_quad2_pi[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
			}

		      if (pngc_adcInt < 2000 && pngc_adcInt != 0.0 && (ppshwr_adcPulseInt + pshwr_adcPulseInt) != 0.0)
			{
			  h_phgc_quad2_pi[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
			}			
		    }//Quadrant 2

		  if (trk_y[0] + trk_phi[0] * nhgc_z >= 4.6 && trk_x[0] + trk_theta[0] * nhgc_z < 9.4)
		    {
		      h_phgc_quad3_sum[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
		      if (pngc_adcInt >= 2000 && pngc_adcInt != 0.0 && (ppshwr_adcPulseInt + pshwr_adcPulseInt) != 0.0)
			{
			  if ((ppshwr_adcPulseInt + pshwr_adcPulseInt) >= shwr_ngc_id->Eval(pngc_adcInt)) h_phgc_quad3_e[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
			  if ((ppshwr_adcPulseInt + pshwr_adcPulseInt) < shwr_ngc_id->Eval(pngc_adcInt)) h_phgc_quad3_pi[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
			}
		      if (pngc_adcInt < 2000 && pngc_adcInt != 0.0 && (ppshwr_adcPulseInt + pshwr_adcPulseInt) != 0.0)
			{
			  h_phgc_quad3_pi[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
			}
		    }//Quadrant 3

		  if (trk_y[0] + trk_phi[0] * nhgc_z < 4.6 && trk_x[0] + trk_theta[0] * nhgc_z < 9.4)
		    {
		      h_phgc_quad4_sum[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
		      if (pngc_adcInt >= 2000 && pngc_adcInt != 0.0 && (ppshwr_adcPulseInt + pshwr_adcPulseInt) != 0.0)
			{
			  if ((ppshwr_adcPulseInt + pshwr_adcPulseInt) >= shwr_ngc_id->Eval(pngc_adcInt)) h_phgc_quad4_e[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
			  if ((ppshwr_adcPulseInt + pshwr_adcPulseInt) < shwr_ngc_id->Eval(pngc_adcInt)) h_phgc_quad4_pi[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
			}
		      if (pngc_adcInt < 2000 && pngc_adcInt != 0.0 && (ppshwr_adcPulseInt + pshwr_adcPulseInt) != 0.0)
			{
			  h_phgc_quad4_pi[pmt_hit]->Fill(phgc_pulseInt[ihgchit]);
			}	
		    }//Quadrant 4
		}//Condition for PulseAmp > 70mV
	    }
	  if (phgc_pulseInt[ihgchit] != 0.0) h_phgc_adcPulseIntSum->Fill(phgc_pulseInt[ihgchit]);
	  ...
	  if (phgc_pulseInt[ihgchit] != 0.0 && (ppshwr_adcPulseInt + pshwr_adcPulseInt) != 0.0) h2_pshwr_vs_phgcer->Fill(phgc_pulseInt[ihgchit], pshwr_adcPulseInt + ppshwr_adcPulseInt);
	  ...
	  */
	  ...
	  if (pngc_adcInt > 2000 && pngc_adcInt != 0.0 && (ppshwr_adcPulseInt + pshwr_adcPulseInt) != 0.0)
		...
		{
		  h2_pshwr_vs_pngc_ecut->Fill(pngc_adcInt, pshwr_adcPulseInt + ppshwr_adcPulseInt);
		  h_phgc_adcPulseIntSum_e->Fill(phgc_pulseInt[ihgchit]);
		}
		if ((ppshwr_adcPulseInt + pshwr_adcPulseInt) < shwr_ngc_id->Eval(pngc_adcInt))
		{
		  h2_pshwr_vs_pngc_picut->Fill(pngc_adcInt, pshwr_adcPulseInt + ppshwr_adcPulseInt);
		  h_phgc_adcPulseIntSum_pi->Fill(phgc_pulseInt[ihgchit]);
		}
	    }
	  ...
	  if (i/4 == 1)//Quadrant 2
	    {
	      ...
	      h_phgc_quad2_e[2]->DrawCopy("same");trk_x[0] + trk_theta[0] * nhgc_z, trk_y[0] + trk_phi[0] * nhgc_z,phgc_pulseInt[ihgchit])
