...
void photoelectron_conversion_pulseInt(Int_t RunNumber=0)
{
  int num_pars = 6;
  int fit_max = 6000;
  int fit_min = 200;
  ...
  for (int i=0;i<4;i++) 
      ...
      for (int j=0;j<4;j++)
	{
	  ...
	  hgc_sum[i][j] = (TH1F*)F->Get(Form("phgc_quad%d_pulseInt_sum%d", i+1, j+1));
	}
    }
  ...
  TF1 *f1 = new TF1("f1",multiple_gauss_test,fit_min,fit_max,15);
  ...
  f1->SetParName(12, "Amplitude 5");
  f1->SetParName(13, "Mean 5");
  f1->SetParName(14, "Std. Dev. 5");  

  
  TF1 *Gauss5 = new TF1("Gauss5",multiple_gauss_test,fit_min,fit_max,15);
  ...
  Gauss5->SetParName(11, "Std. Dev. 4");
  Gauss5->SetParName(12, "Amplitude 5");
  Gauss5->SetParName(13, "Mean 5");
  Gauss5->SetParName(14, "Std. Dev. 5");  

  TF1 *Gauss4 = new TF1("Gauss4",multiple_gauss_test,fit_min,fit_max,12);
  ...
  TF1 *Gauss3 = new TF1("Gauss3",multiple_gauss_test,fit_min,fit_max,9);
  Gauss3->SetParNames("Amplitude 1","Mean 1","Std. Dev. 1","Amplitude 2","Mean 2","Std. Dev. 2","Amplitude 3","Mean 3","Std. Dev. 3");

  TF1 *Gauss2 = new TF1("Gauss2",multiple_gauss_test,fit_min,fit_max,6);
  Gauss2->SetParNames("Amplitude 1","Mean 1","Std. Dev. 1","Amplitude 2","Mean 2","Std. Dev. 2");

  TF1 *Gauss1 = new TF1("Gauss1",multiple_gauss_test,fit_min,fit_max,3);
  ...
  Double_t x_all[12], y_all[12], y_allerr[12], x_allerr[12];
  ...
  for (int k=0; k<4; k++)
      ...
      for (int i=0; i<4; i++)
	{
      ...
      TH1F *total_k = (TH1F*)hgc_sum[0][k]->Clone(Form("total_%d",k));
      total_k->Reset();
      total_k->Merge(list_all);
      ...
      for (int n=0;n<12;n++)
	{
      ...
      f1->SetParameter(12, 200);
      f1->SetParameter(13, 2500);
      f1->SetParameter(14, 200);
      f1->SetParLimits(0, 100., 5000.);
      f1->SetParLimits(3, 100., 5000.);
      f1->SetParLimits(6, 100., 5000.);
      f1->SetParLimits(9, 100., 5000.);
      f1->SetParLimits(12, 100., 5000.);

      TCanvas *c0_k = new TCanvas(Form("c0_%d",k),Form("PMT %d, Sum over all Off-Diagonal Quadrants",k+1));
      all_k->Fit("f1","REMB");
      gPad->Update();
      if (f1->GetChisquare()/f1->GetNDF() > 2.5 || f1->GetChisquare()/f1->GetNDF() < 0.7)
	{
      ...
      Gauss5->SetParameters(f1->GetParameter(0),f1->GetParameter(1),f1->GetParameter(2),f1->GetParameter(3),f1->GetParameter(4),f1->GetParameter(5),f1->GetParameter(6),f1->GetParameter(7),f1->GetParameter(8),f1->GetParameter(9));
      Gauss5->SetParameter(10, f1->GetParameter(10));
      Gauss5->SetParameter(11, f1->GetParameter(11));
      Gauss5->SetParameter(12, f1->GetParameter(9));
      Gauss5->SetParameter(13, f1->GetParameter(10) + 500);
      Gauss5->SetParameter(14, f1->GetParameter(11));
      Gauss5->SetParLimits(1, f1->GetParameter(1) - 50, f1->GetParameter(1) + 50);
      Gauss5->SetParLimits(4, f1->GetParameter(4) - 100, f1->GetParameter(4) + 100);
      Gauss5->SetParLimits(7, f1->GetParameter(7) - 250, f1->GetParameter(7) + 250);
      Gauss5->SetParLimits(10, f1->GetParameter(10) - 500, f1->GetParameter(10) + 500);
      Gauss5->SetParLimits(0, 5., 5000.);
      Gauss5->SetParLimits(3, 5., 5000.);
      Gauss5->SetParLimits(6, 5., 5000.);
      Gauss5->SetParLimits(9, 5., 5000.);
      Gauss5->SetParLimits(2, 0., 1000.);
      Gauss5->SetParLimits(5, 0., 1000.);
      Gauss5->SetParLimits(8, 0., 1000.);
      Gauss5->SetParLimits(11, 0., 1000.);
      ...
      Gauss4->SetParLimits(4, f1->GetParameter(4) - 100, f1->GetParameter(4) + 100);
      Gauss4->SetParLimits(7, f1->GetParameter(7) - 250, f1->GetParameter(7) + 250);
      Gauss4->SetParLimits(10, f1->GetParameter(10) - 500, f1->GetParameter(10) + 500);
      ...
      Gauss3->SetParLimits(4, f1->GetParameter(4)- 100, f1->GetParameter(4)+100);
      Gauss3->SetParLimits(7, f1->GetParameter(7)- 250, f1->GetParameter(7)+250);
      ...
      Gauss2->SetParLimits(4, f1->GetParameter(4)- 100, f1->GetParameter(4)+100);
      ...
      for (int i=0;i<4;i++)
	{
	  ...
	  if (Gauss4->GetNDF() == 0 || Gauss4->GetChisquare()/Gauss4->GetNDF() > 2.5 || Gauss4->GetChisquare()/Gauss4->GetNDF() < 0.7)
	    {
	      cout << "Decreasing Peak Numbers for hgc_e[" << i << "][" << k << "]" << endl;
	      hgc_e[i][k]->Fit("Gauss3","REMBQ");
	      if (Gauss3->GetNDF() == 0 || Gauss3->GetChisquare()/Gauss3->GetNDF() > 2.5 || Gauss3->GetChisquare()/Gauss3->GetNDF() < 0.7)
		{
		  cout << "Decreasing Peak Numbers for hgc_e[" << i << "][" << k << "]" << endl;
		  hgc_e[i][k]->Fit("Gauss2","REMBQ");
		  if (Gauss2->GetNDF() == 0 || Gauss2->GetChisquare()/Gauss2->GetNDF() > 2.5 || Gauss2->GetChisquare()/Gauss2->GetNDF() < 0.7)
		    {
		      cout << "Decreasing Peak Numbers for hgc_e[" << i << "][" << k << "]" << endl;
		      hgc_e[i][k]->Fit("Gauss1","REMBQ");
		      if (Gauss1->GetNDF() > 0) root_chi = pow(Gauss1->GetChisquare()/Gauss1->GetNDF(), 0.5);
		      else root_chi = 0;
		      x_e[j] = 1, y_e[j] = Gauss1->GetParameter(1), y_eerr[j] = Gauss1->GetParError(1)*root_chi, x_eerr[j] = 0;
		      j = j+1;
		      continue;
		    }
		  if (Gauss2->GetNDF() > 0) root_chi = pow(Gauss2->GetChisquare()/Gauss2->GetNDF(), 0.5);
		  else root_chi = 0;
	      ...
	      if (Gauss3->GetNDF() > 0) root_chi = pow(Gauss3->GetChisquare()/Gauss3->GetNDF(), 0.5);
	      else root_chi = 0;
	  ...
	  if (Gauss4->GetNDF() > 0) root_chi = pow(Gauss4->GetChisquare()/Gauss4->GetNDF(), 0.5);
	  else root_chi = 0;
      ...
      for (int i=0;i<12;i++)
	{
      ...
      if (Gauss5->GetNDF() > 0) root_chi = pow(Gauss5->GetChisquare()/Gauss5->GetNDF(), 0.5);
      x_all[0] = 1, y_all[0] = Gauss5->GetParameter(1), y_allerr[0] = Gauss5->GetParError(1)*root_chi, x_allerr[0] = 0;
      x_all[1] = 2, y_all[1] = Gauss5->GetParameter(4), y_allerr[1] = Gauss5->GetParError(4)*root_chi, x_allerr[1] = 0;
      x_all[2] = 3, y_all[2] = Gauss5->GetParameter(7), y_allerr[2] = Gauss5->GetParError(7)*root_chi, x_allerr[2] = 0;
      x_all[3] = 4, y_all[3] = Gauss5->GetParameter(10), y_allerr[3] = Gauss5->GetParError(10)*root_chi, x_allerr[3] = 0;
      x_all[4] = 5, y_all[4] = Gauss5->GetParameter(13), y_allerr[4] = Gauss5->GetParError(13)*root_chi, x_allerr[4] = 0;

      gr_all_k =  new TGraphErrors(5, x_all, y_all, x_allerr, y_allerr);
      
      TCanvas *plot_all_k = new TCanvas(Form("plot_all_%d",k), Form("PMT %d, Focal Plane Calibration",k+1));
      gr_all_k->Fit("pol1");
      gr_all_k->Draw("A*");
